...
echo "Question 3: What is the best engineering major?<br>";
echo "You answered: " . $question3 . "<br>";
echo "Correct answer: Computer Science<br>";
echo "<br>";

echo "Question 4: What is the most recent national championship for KU basketball<br>";
...
if ($question3 == "Computer Science") {$correctAns += 1;}
if ($question4 == "2022") {$correctAns += 1;}
